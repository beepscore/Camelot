...
public var SurveyTask: ORKOrderedTask {
    ...
    func addInstructionStepToSteps() {
    ...
    func addNameQuestionStepToSteps() {
    ...
    func addQuestQuestionStepToSteps() {
    ...
    func addColorQuestionStepToSteps() {
    ...
    addInstructionStepToSteps()
    addNameQuestionStepToSteps()
    addQuestQuestionStepToSteps()
    addColorQuestionStepToSteps()
